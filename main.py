## Import Libraries
from fastapi import FastAPI, BackgroundTasks     #BackgroundTasks : help to remove the photos from your machine
from starlette.responses import FileResponse     # to show photo on app 
import os
